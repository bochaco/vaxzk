      ...
      [
        providers.publicDataProvider
          ...
          .pipe(
            ...
            tap((ledgerState) =>
              console.log(
                `ledger state changed: invites: ${ledgerState.totalInviteClinic} admins; ${ledgerState.totalAdmin} clinics: ${ledgerState.clinics.size()}, vaccines: ${ledgerState.vaccines.size()}`,
              ),
            ),
          ),
        from(
