      ...
      [
        providers.publicDataProvider
          ...
          .pipe(
            ...
            tap((ledgerState) =>
              console.log(
                `ledger state changed: invites: ${ledgerState.inviteClinicHash.size()} admins; ${ledgerState.admins.size()} clinics: ${ledgerState.clinics.size()}, vaccines: ${ledgerState.vaccines.size()}`,
              ),
            ),
          ),
        from(
