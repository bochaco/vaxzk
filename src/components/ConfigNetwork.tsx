// export const FIRSTCONTRACTID = "140b5d4c7b538b989682bb251d7729b544092caa9e53a8059f686fd9fb0fc8b9"
...
export function getContractId(): string {
  return localStorage.getItem(CONTRACT_STORAGE_KEY) ?? FIRSTCONTRACTID;
}
