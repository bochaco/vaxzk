...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      addAdmin: (...args_1) => {
        ...
        const _adminSk_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('addAdmin',
                                     'argument 1 (as invoked from Typescript)',
                                     'vaxzk.compact line 26 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(_adminSk_0.buffer instanceof ArrayBuffer && _adminSk_0.BYTES_PER_ELEMENT === 1 && _adminSk_0.length === 32)) {
          __compactRuntime.typeError('addAdmin',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(_adminSk_0),
        ...
        const result_0 = this._addAdmin_0(context, partialProofData, _adminSk_0);
      ...
      adminOnlyAction: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`adminOnlyAction: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const someParam_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('adminOnlyAction',
                                     'argument 1 (as invoked from Typescript)',
                                     'vaxzk.compact line 44 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(someParam_0) === 'bigint' && someParam_0 >= 0n && someParam_0 <= 65535n)) {
          __compactRuntime.typeError('adminOnlyAction',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'vaxzk.compact line 44 char 1',
                                     'Uint<0..65536>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(someParam_0),
        ...
        const result_0 = this._adminOnlyAction_0(context,
                                                 partialProofData,
                                                 someParam_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      ...
      addClinic: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const _clinicSk_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('addClinic',
                                     'argument 1 (as invoked from Typescript)',
                                     'vaxzk.compact line 49 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(_clinicSk_0.buffer instanceof ArrayBuffer && _clinicSk_0.BYTES_PER_ELEMENT === 1 && _clinicSk_0.length === 32)) {
          __compactRuntime.typeError('addClinic',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'vaxzk.compact line 49 char 1',
                                     'Bytes<32>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(_clinicSk_0),
            alignment: _descriptor_0.alignment()
          },
          output: undefined,
          publicTranscript: [],
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('adminOnlyAction', new __compactRuntime.ContractOperation());
  ...
  _addAdmin_0(context, partialProofData, _adminSk_0) {
    this._isAdmin_0(context, partialProofData);
    const newAdminPubKey_0 = this._publicKey_0(_adminSk_0);
    __compactRuntime.assert(!_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
                                                                                                 ...
                                                                                                 path: [
                                                                                                        { tag: 'value',
                                                                                                          value: { value: _descriptor_8.toValue(0n),
                                                                                                                   alignment: _descriptor_8.alignment() } }] } },
                                                                                        { push: { storage: false,
                                                                                                  value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(newAdminPubKey_0),
                                                                                                                                               alignment: _descriptor_0.alignment() }).encode() } },
                                                                                        'member',
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                            'You are already in the admin list');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
  ...
  _revokeAdmin_0(context, partialProofData, _adminSk_0) {
    this._isAdmin_0(context, partialProofData);
    const newAdminPubKey_0 = this._publicKey_0(_adminSk_0);
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
  ...
  _adminOnlyAction_0(context, partialProofData, someParam_0) {
    this._isAdmin_0(context, partialProofData); return [];
  }
  _addClinic_0(context, partialProofData, _clinicSk_0) {
    this._isAdmin_0(context, partialProofData);
    const newClinicPubKey_0 = this._publicKey_0(_clinicSk_0);
    __compactRuntime.assert(!_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
                                                                                                 ...
                                                                                                 path: [
                                                                                                        { tag: 'value',
                                                                                                          value: { value: _descriptor_8.toValue(1n),
                                                                                                                   alignment: _descriptor_8.alignment() } }] } },
                                                                                        { push: { storage: false,
                                                                                                  value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(newClinicPubKey_0),
                                                                                                                                               alignment: _descriptor_0.alignment() }).encode() } },
                                                                                        'member',
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                            'You are already in the clinic list');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
  ...
  _revokeClinic_0(context, partialProofData, _clinicSk_0) {
    this._isAdmin_0(context, partialProofData);
    const newClinicPubKey_0 = this._publicKey_0(_clinicSk_0);
    __compactRuntime.assert(!_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        ...
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                            'You are not in the clinic list');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
